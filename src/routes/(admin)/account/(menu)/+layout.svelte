...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content">
    <div class="navbar bg-base-100 lg:hidden">
      <div class="flex-1">
        <a class="btn btn-ghost normal-case text-xl" href={localizeHref("/")}
          >{WebsiteName}</a
        >
      </div>
      <div class="flex-none">
  ...
  <div class="drawer-side">
    ...
    >
      <li>
        ...
        >
          <a href={localizeHref("/")} class="grow">{WebsiteName}</a>
      ...
      <li class="mt-auto">
        <a href={localizeHref("/account/sign_out")} class="mt-auto text-base"
          >Sign Out</a
        >
      </li>
    </ul>
